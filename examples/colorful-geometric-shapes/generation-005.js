 ...
 * Generation 4: add new shapes and colors
 * Generation 5: add gradient background
 */
...
async function run() {
  return `
    ...
    const shapes = [];
    const colors = ["red", "blue", "green", "yellow", "purple", "orange", "pink", "teal", "brown", "magenta", "cyan", "lime"];
    const size = 50;

    for (let i = 0; i < 75; i++) {
      const shape = ["circle", "square", "triangle", "pentagon", "hexagon"][Math.floor(Math.random() * 5)];
